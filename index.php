...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        ...
        <li><a class="active-menu" href="#"><i class="fa fa-home"></i> Home</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                             <h4>Uploaded (K9Connectables) Customer Orders</h4>
                        </div></div>
                    </div></div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                             <h5>Navigate to Customer Order cvs file and upload</h5>
                        </div>
                        <div class="panel-body">
                           <form class="form-inline" action="track/functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                             <h5>Export our file to a place on your desktop</h5>
                        </div>
                <div class="panel-body">                     
                     <form class="form-inline" action="track/functions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                        <div class="form-group">
