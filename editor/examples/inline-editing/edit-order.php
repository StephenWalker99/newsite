...
$(document).ready(function() {
	...
	$('#edit-order').on( 'click', 'tbody tr:not(.child) td:not(:first-child), tbody span.dtr-data', function (e) {
		editor.inline( this );
	} );

	$('#edit-order').DataTable( {
		responsive: true,
		dom: "Bfrtip",
		ajax: "../php/edit-order.php",
		columns: [
...
<!-- /. NAV TOP  -->
    ...
    <div id="page-wrapper" >
            ...
            <div class="row">
                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4>Edit (K9 Connectables) Customer Orders</h4>
                        </div>
                ...
                <table id="edit-order" class="display nowrap" width="100%" cellspacing="0">
				<thead>
					<tr>
						<th></th>
						<th>Created</th>
