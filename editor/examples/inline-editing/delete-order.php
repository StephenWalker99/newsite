...
$(document).ready(function() {
	...
	$('#delete-order').on( 'click', 'tbody tr:not(.child) td:not(:first-child), tbody span.dtr-data', function (e) {
		editor.inline( this );
	} );
...
<!-- /. NAV TOP  -->
    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        ...
        <li><a href="add-order.php">Add Customer Records</a>
        </li>
        </ul></li> 
        </ul>
      </div>
    ...
    <div id="page-wrapper" >
            ...
            <div class="row">
                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4>Delete (K9 Connectables) Customer Orders</h4>
                        </div>
                ...
                <table id="delete-order" class="table table-striped table-hover dt-responsive" cellspacing="0">
				<thead>
					<tr>
						<th></th>
                        <th>Created</th>
