...
// Steve added to stop deleting from the database
...
Editor::inst( $db, 'tracking', 'user_id', 'track_date', 'order_no', 'service', 'billing_name','postcode','shipping_country','weight','carton_quantity','pick_no')
	->fields(
