    ...
    <!-- /. NAV SIDE  -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4> Add New (K9 User) For Customer Orders</h4>
                        </div></div>
                    </div></div>
        ...
        <div class="row text-center">
            <div class="col-md-12">
                ...
                <h2>k9 Connectable Admin : Register New K9 User</h2>
                        ...
                        <strong>  New Admin? Register Yourself Here</strong>  
                            ...
                            <div class="panel-body">
                              <div class="request-form">
                                ...
                                <!-- Begin Form -->   
                                <form id="registerUser" enctype="multipart/form-data" method="post">
...
<script>
    ...
    <script src="controller/class.controller.registerUser.js"></script>
