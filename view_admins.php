                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4> View and Search Admin Users</h4>
                        </div></div>
                    </div></div>  
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="panel-group" id="accordion">                     
                        <div class="panel panel-info">
                            <div class="panel-heading">
                            <class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed">Admin Users (click to close/open)</a>
                        </div>
                        <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                        <div class="panel-body">
                         <div class='table-responsive'>
                          <table id="steve" class="display nowrap" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                                <td>First Name</td>
                                <td>Last Name</td>
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: "editor/examples/php/admin-user.php",
        table: "#steve",
        fields: [ {
                label: "First name:",
                name: "firstN",
    ...
    columns: [
            ...
            { data: null,
                  ...
                  return '<img src="uploads/img/'+data.image+'",width=40px, height=40px />'
              },
                  orderable: false
              }, 
    ],
