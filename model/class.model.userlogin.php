...
if($action=="login"){
login($Host, $User, $Password, $DBName, $table_1, $table_2);
}

function login($Host, $User, $Password, $DBName, $table_1, $table_2){
...
//Make our connection
		...
		$Query = "SELECT * FROM $table_2 WHERE email = '".$formValue['email']."'";
